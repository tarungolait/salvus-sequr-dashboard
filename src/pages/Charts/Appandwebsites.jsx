        ...
        <form className="w-full max-w-lg">
          <table className="w-full">
            <tbody>
              ...
              <tr>
                <td className="px-3 py-2">
                  <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="type-of-app">
                    TYPE OF APP
                  </label>
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="type-of-app" type="text" placeholder="Enter type of app" />
                </td>
                <td className="px-3 py-2">
                  <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="country-of-origin">
                    COUNTRY OF ORIGIN
                  </label>
                  <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="country-of-origin" type="text" placeholder="Enter country of origin" />
                </td>
              </tr>
              <tr>
                <td className="px-3 py-2">
